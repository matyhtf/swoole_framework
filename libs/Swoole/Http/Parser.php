...
class Parser
{
    ...
    {
        $request->head['Content-Type'] = isset($request->head['Content-Type']) ? $request->head['Content-Type'] : 'application/x-www-form-urlencoded';
        if (strstr($request->head['Content-Type'], 'boundary') !== false) {
